...
import { FormEntityKeepProps } from 'src/types';
import useFormEntityKeep from 'src/components/FormEntityKeep/useFormEntityKeep';
...
function FormEntityKeep(props: FormEntityKeepProps): JSX.Element {
  const { data, fns } = useFormEntityKeep();
